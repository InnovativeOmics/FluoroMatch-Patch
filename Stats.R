...
getDataColumns<- function(inputData,name,fc){
  numOfSamples <- colnames(inputData)
  header <- colnames(inputData)
  count <- 0
...
#Volcano's Calculations
{
  twoGroupingGetCalculation <- function(inputData,targets,normalized){
    ...
    if (normalized) {
      ...
      g1Avg<- cbind(averageNormData(tmpData,targets[1],f))
      g2Avg<- cbind(averageNormData(tmpData,targets[2],f))
      
    }
    else{
      f <- c(rep(0.0,nrow(tmpData)))
      g1Avg<- rbind(averageData(tmpData,targets[1],f))
      g2Avg<- rbind(averageData(tmpData,targets[2],f))
    ...
    f <- c(rep(0.0,ncol(tmpData)))
    g1Data <- data.frame(getDataColumns(tmpData,targets[1],f))
    g2Data <- data.frame(getDataColumns(tmpData,targets[2],f))
  ...
  threeGroupingGetCalculations <- function(inputData,targets,normalized){
    ...
    if (normalized) {
      f <- c(rep(0.0,ncol(tmpData)))
      g1Avg<- rbind(averageNormData(tmpData,targets[1],f))
      g2Avg<- rbind(averageNormData(tmpData,targets[2],f))
      g3Avg<- rbind(averageNormData(tmpData,targets[3],f))
      ...
      g1Avg<- rbind(averageData(tmpData,targets[1],f))
      g2Avg<- rbind(averageData(tmpData,targets[2],f))
      g3Avg<- rbind(averageData(tmpData,targets[3],f))
    ...
    g1Data <- data.frame(getDataColumns(tmpData,targets[1],f))
    g2Data <- data.frame(getDataColumns(tmpData,targets[2],f))
    g3Data <- data.frame(getDataColumns(tmpData,targets[3],f))
  ...
  fourGroupingGetCalculations <- function(inputData,targets,normalized){
    ...
    if (normalized) {
      ...
      g2Avg<- rbind(averageNormData(tmpData,targets[2],f))
      g3Avg<- rbind(averageNormData(tmpData,targets[3],f))
      g4Avg<- rbind(averageNormData(tmpData,targets[4],f))
      ...
      g2Avg<- rbind(averageData(tmpData,targets[2],f))
      g3Avg<- rbind(averageData(tmpData,targets[3],f))
      g4Avg<- rbind(averageData(tmpData,targets[4],f))
    ...
    g2Data <- data.frame(getDataColumns(tmpData,targets[2],f))
    g3Data <- data.frame(getDataColumns(tmpData,targets[3],f))
    g4Data <- data.frame(getDataColumns(tmpData,targets[4],f))
  ...
  fiveGroupingGetCalculations <- function(inputData,targets,normalized){
    ...
    if (normalized) {
      ...
      g3Avg<- rbind(averageNormData(tmpData,targets[3],f))
      g4Avg<- rbind(averageNormData(tmpData,targets[4],f))
      g5Avg<- rbind(averageNormData(tmpData,targets[5],f))
      ...
      g3Avg<- rbind(averageData(tmpData,targets[3],f))
      g4Avg<- rbind(averageData(tmpData,targets[4],f))
      g5Avg<- rbind(averageData(tmpData,targets[5],f))
    ...
    g3Data <- data.frame(getDataColumns(tmpData,targets[3],f))
    g4Data <- data.frame(getDataColumns(tmpData,targets[4],f))
    g5Data <- data.frame(getDataColumns(tmpData,targets[5],f))
  ...
  sixGroupingGetCalculations <- function(inputData,targets,normalized){
    ...
    if (normalized) {
      ...
      g4Avg<- rbind(averageNormData(tmpData,targets[4],f))
      g5Avg<- rbind(averageNormData(tmpData,targets[5],f))
      g6Avg<- rbind(averageNormData(tmpData,targets[6],f))
      ...
      g4Avg<- rbind(averageData(tmpData,targets[4],f))
      g5Avg<- rbind(averageData(tmpData,targets[5],f))
      g6Avg<- rbind(averageData(tmpData,targets[6],f))
    ...
    g4Data <- data.frame(getDataColumns(tmpData,targets[4],f))
    g5Data <- data.frame(getDataColumns(tmpData,targets[5],f))
    g6Data <- data.frame(getDataColumns(tmpData,targets[6],f))
  ...
  sevenGroupingGetCalculations <- function(inputData,targets,normalized){
    ...
    if (normalized) {
      ...
      g1Avg<- cbind(averageNormData(tmpData,targets[1],f))
      g2Avg<- cbind(averageNormData(tmpData,targets[2],f))
      g3Avg<- cbind(averageNormData(tmpData,targets[3],f))
      g4Avg<- cbind(averageNormData(tmpData,targets[4],f))
      g5Avg<- cbind(averageNormData(tmpData,targets[5],f))
      g6Avg<- cbind(averageNormData(tmpData,targets[6],f))
      g7Avg<- cbind(averageNormData(tmpData,targets[7],f))
      ...
      g5Avg<- rbind(averageData(tmpData,targets[5],f))
      g6Avg<- rbind(averageData(tmpData,targets[6],f))
      g7Avg<- rbind(averageData(tmpData,targets[7],f))
    ...
    g5Data <- data.frame(getDataColumns(tmpData,targets[5],f))
    g6Data <- data.frame(getDataColumns(tmpData,targets[6],f))
    g7Data <- data.frame(getDataColumns(tmpData,targets[7],f))
  ...
  eightGroupingGetCalculations <- function(inputData,targets,normalized){
    ...
    if (normalized) {
      ...
      g5Avg<- rbind(averageNormData(tmpData,targets[5],f))
      g6Avg<- rbind(averageNormData(tmpData,targets[6],f))
      g7Avg<- rbind(averageNormData(tmpData,targets[7],f))
      g8Avg<- rbind(averageNormData(tmpData,targets[8],f))
      ...
      g6Avg<- rbind(averageData(tmpData,targets[6],f))
      g7Avg<- rbind(averageData(tmpData,targets[7],f))
      g8Avg<- rbind(averageData(tmpData,targets[8],f))
    ...
    g6Data <- data.frame(getDataColumns(tmpData,targets[6],f))
    g7Data <- data.frame(getDataColumns(tmpData,targets[7],f))
    g8Data <- data.frame(getDataColumns(tmpData,targets[8],f))
  ...
  nineGroupingGetCalculations <- function(inputData,targets,normalized){
    ...
    if (normalized) {
      ...
      g7Avg<- rbind(averageNormData(tmpData,targets[7],f))
      g8Avg<- rbind(averageNormData(tmpData,targets[8],f))
      g9Avg<- rbind(averageNormData(tmpData,targets[9],f))
      ...
      g7Avg<- rbind(averageData(tmpData,targets[7],f))
      g8Avg<- rbind(averageData(tmpData,targets[8],f))
      g9Avg<- rbind(averageData(tmpData,targets[9],f))
    ...
    g7Data <- data.frame(getDataColumns(tmpData,targets[7],f))
    g8Data <- data.frame(getDataColumns(tmpData,targets[8],f))
    g9Data <- data.frame(getDataColumns(tmpData,targets[9],f))
  ...
  tenGroupingGetCalculations <- function(inputData,targets,normalized){
    ...
    if (normalized) {
      ...
      g8Avg<- rbind(averageNormData(tmpData,targets[8],f))
      g9Avg<- rbind(averageNormData(tmpData,targets[9],f))
      g10Avg<- rbind(averageNormData(tmpData,targets[10],f))
      ...
      g8Avg<- rbind(averageData(tmpData,targets[8],f))
      g9Avg<- rbind(averageData(tmpData,targets[9],f))
      g10Avg<- rbind(averageData(tmpData,targets[10],f))
...
#Anova Functions
{
  calculateThreeGroupAnova<- function(set1,set2,set3, container){
    anovaSets <- c(set1[[1]],set2[[1]],set3[[1]])
    anovaGroups <- c(rep.int(container[1],times= nrow(set1)),rep.int(container[2],times= nrow(set1)),
                     rep.int(container[3],times= nrow(set1)))
    
    aModel <- aov(anovaSets~anovaGroups)
    
    return(aModel)
    
  }
  
  calculateFourGroupAnova<- function(set1,set2,set3,set4, container){
    anovaSets <- c(set1[[1]],set2[[1]],set3[[1]],set4[[1]])
    anovaGroups <- c(rep.int(container[1],times= nrow(set1)),rep.int(container[2],times= nrow(set1)),
                     rep.int(container[3],times= nrow(set1)),rep.int(container[4],times= nrow(set1)))
  ...
  calculateFiveGroupAnova<- function(set1,set2,set3,set4,set5, container){
    anovaSets <- c(set1[[1]],set2[[1]],set3[[1]],set4[[1]],set5[[1]])
    anovaGroups <- c(rep.int(container[1],times= nrow(set1)),rep.int(container[2],times= nrow(set1)),
                     rep.int(container[3],times= nrow(set1)),rep.int(container[4],times= nrow(set1)),
                     rep.int(container[5],times= nrow(set1)))
  ...
  calculateSixGroupAnova<- function(set1,set2,set3,set4,set5,set6, container,inputData){
    anovaSets <- c(set1[[1]],set2[[1]],set3[[1]],set4[[1]],set5[[1]],set6[[1]])
    anovaGroups <- c(rep.int(container[1],times= nrow(set1)),rep.int(container[2],times= nrow(set1)),
                     rep.int(container[3],times= nrow(set1)),rep.int(container[4],times= nrow(set1)),
                     rep.int(container[5],times= nrow(set1)),rep.int(container[6],times= nrow(set1)))
  ...
  calculateSevenGroupAnova<- function(set1,set2,set3,set4,set5,set6,set7, container){
    
    anovaSets <- c(set1[[1]],set2[[1]],set3[[1]],set4[[1]],set5[[1]],set6[[1]],set7[[1]])
    anovaGroups <- c(rep.int(container[1],times= nrow(set1)),rep.int(container[2],times= nrow(set1)),
                     rep.int(container[3],times= nrow(set1)),rep.int(container[4],times= nrow(set1)),
                     rep.int(container[5],times= nrow(set1)),rep.int(container[6],times= nrow(set1)),
                     rep.int(container[7],times= nrow(set1)))
  ...
  calculateEightGroupAnova<- function(set1,set2,set3,set4,set5,set6,set7,set8, container){
    anovaSets <- c(set1[[1]],set2[[1]],set3[[1]],set4[[1]],set5[[1]],set6[[1]],set7[[1]],set8[[1]])
    anovaGroups <- c(rep.int(container[1],times= nrow(set1)),rep.int(container[2],times= nrow(set1)),
                     rep.int(container[3],times= nrow(set1)),rep.int(container[4],times= nrow(set1)),
                     rep.int(container[5],times= nrow(set1)),rep.int(container[6],times= nrow(set1)),
                     rep.int(container[7],times= nrow(set1)),rep.int(container[8],times= nrow(set1)))
    aModel <- aov(anovaSets~anovaGroups)
  ...
  calculateNineGroupAnova<- function(set1,set2,set3,set4,set5,set6,set7,set8,set9, container){
    anovaSets <- c(set1[[1]],set2[[1]],set3[[1]],set4[[1]],set5[[1]],set6[[1]],set7[[1]],set8[[1]],set9[[1]])
    anovaGroups <- c(rep.int(container[1],times= nrow(set1)),rep.int(container[2],times= nrow(set1)),
                     rep.int(container[3],times= nrow(set1)),rep.int(container[4],times= nrow(set1)),
                     rep.int(container[5],times= nrow(set1)),rep.int(container[6],times= nrow(set1)),
                     rep.int(container[7],times= nrow(set1)),rep.int(container[8],times= nrow(set1)),
                     rep.int(container[9],times= nrow(set1)))
    aModel <- aov(anovaSets~anovaGroups)
  ...
  calculateTenGroupAnova<- function(set1,set2,set3,set4,set5,set6,set7,set8,set9,set10, container){
    anovaSets <- c(set1[[1]],set2[[1]],set3[[1]],set4[[1]],set5[[1]],set6[[1]],set7[[1]],set8[[1]],set9[[1]],set10[[1]])
    anovaGroups <- c(rep.int(container[1],times= nrow(set1)),rep.int(container[2],times= nrow(set1)),
                     rep.int(container[3],times= nrow(set1)),rep.int(container[4],times= nrow(set1)),
                     rep.int(container[5],times= nrow(set1)),rep.int(container[6],times= nrow(set1)),
                     rep.int(container[7],times= nrow(set1)),rep.int(container[8],times= nrow(set1)),
                     rep.int(container[9],times= nrow(set1)),rep.int(container[10],times= nrow(set1)))
    aModel <- aov(anovaSets~anovaGroups)
...
ANOVA.Anal<-function(mSetObj=NA, nonpar=FALSE, thresh=0.05, post.hoc="fisher", all_results=FALSE,outDir) {
  ...
  if(sig.num> 0){
    res <- 1;
    write.csv(sig.mat,paste(OutputDirectory,"/anova_posthoc.csv",sep=""))
...
OutputData<-function(OutputDirectory,GroupCSVDirectory,CommentColumn,type){
  ...
  if (length(smpls)>2) {
    ...
    mset<-ANOVA.Anal(mset,"F",0.05,"fisher",FALSE,OutputDirectory)
